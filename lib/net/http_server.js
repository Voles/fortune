...
/**
 * **Node.js only**: This function implements a HTTP server for Fortune, it's a
 * static method available at `Fortune.net.http`. The integration with Fortune
 * is minimal: it determines which serializer to use, assigns request headers
...
function http (instance, options) {
  ...
  var i, j, input, CustomSerializer, mediaType,
    settings, endResponse, useCompression, useETag
  var mediaTypes = []
  var serializers = {}
...
http.HtmlSerializer = htmlSerializer(HttpSerializer)
